...
// Новый иконка: Company Members
export function Members(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx="29" cy="29" r="29" fill="#FF7F50" />
      <circle cx="20" cy="24" r="5" fill="#fff" />
      <circle cx="38" cy="24" r="5" fill="#fff" />
      <ellipse cx="29" cy="38" rx="12" ry="6" fill="#fff" />
    </svg>
  );
}

// Новый иконка: Sections (отображает сетку или разделы)
export function Sections(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx="29" cy="29" r="29" fill="#6C63FF" />
      <rect x="19" y="19" width="10" height="10" rx="1" fill="#fff" />
      <rect x="31" y="19" width="10" height="10" rx="1" fill="#fff" />
      <rect x="19" y="31" width="10" height="10" rx="1" fill="#fff" />
      <rect x="31" y="31" width="10" height="10" rx="1" fill="#fff" />
    </svg>
  );
}

// Новый иконка: Units (количество уроков)
export function Units(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx="29" cy="29" r="29" fill="#FFA500" />
      <rect x="16" y="14" width="26" height="30" rx="3" fill="#fff" />
      <path d="M42 14 L37 14 L42 19 Z" fill="#ccc" />
    </svg>
  );
}

export function ActiveUsers(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx="29" cy="29" r="29" fill="#34D399" /> {/* Зеленый */}
      <path d="M29 18a5 5 0 110 10 5 5 0 010-10z" fill="#fff" />
      <path d="M20 38c0-3 6-5 9-5s9 2 9 5v2H20v-2z" fill="#fff" />
    </svg>
  );
}

export function NewRegistrations(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx="29" cy="29" r="29" fill="#6366F1" /> {/* Indigo */}
      <path d="M20 38v-2c0-2 4-4 9-4s9 2 9 4v2H20z" fill="#fff" />
      <circle cx="29" cy="24" r="5" fill="#fff" />
      <path
        d="M29 16v-2M29 42v-2M36.364 20.636l1.414-1.414M20.222 36.778l1.414-1.414M42 29h2M14 29h2M36.364 37.364l1.414 1.414M20.222 21.222l1.414 1.414"
        stroke="#fff"
        strokeWidth="2"
        strokeLinecap="round"
      />
